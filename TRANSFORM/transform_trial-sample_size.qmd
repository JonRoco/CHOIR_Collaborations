...
This sample size calculation is based on data from [@christie2022]. In this study, the Chronic Pain Grade (CPG) mean values were 51.9 pre-treatment and 67 post-treatment, with a p-value of 0.034 in the hight pain intensity group. The estimated standard deviation (SD) from this data was calculated as follows:
